...
echo
echo 'Wichtig:' Das Programm erwartet die Anwesenheit der zu testenden App 
echo direkt auf dem Schreibtisch!
echo
...
echo Aufruf der Website vom WEC mit übertragen werden sollen.
...
[ $agreed != 'Ja' ] && exit 1
echo 
echo Beide Angaben werden nachfolgend abgefragt
echo
